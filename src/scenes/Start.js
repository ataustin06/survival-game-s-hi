...
showRotatePhoneScreen (nextFunction)
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        310,
        'यदि आप मोबाइल फ़ोन का उपयोग कर रहे हैं, तो कृपया आगे बढ़ने के लिए अपने फ़ोन को क्षैतिज (लैंडस्केप) स्थिति में घुमा लें।',
        {
            fontSize: '34px',
            color: '#000000',
            align: 'center',
    ...
    this.createNextButton(640, 520, 'अगला', () => {
...
showFoodCollectionNextButtonIfReady ()
{
    const allThreeCollected =
        this.foodCounts['व्यक्ति A'] > 0 &&
        this.foodCounts['व्यक्ति B'] > 0 &&
        this.foodCounts['व्यक्ति C'] > 0;
...
showTotalFoodEstimateQuestion ()
{
    ...
    this.addQuestionObject(
        this.add.text(
            640,
            220,
            'आपके अनुमान के अनुसार, समूह ने आज कुल कितने भोजन के टुकड़े एकत्र किए?',
            {
                fontSize: '30px',
                color: '#000000',
                align: 'center',
...
const personCDisplayFood = fixedFood.personC;
    ...
    this.addQuestionObject(this.add.text(
        640,
        345,
        'समूह को अपने सदस्यों के बीच भोजन का वितरण कैसे करना चाहिए?',
        {
            fontSize: '29px',
            color: '#000000',
            align: 'center',
    ...
    showPartialRedistributionTask ()
{
    ...
    this.partialRedistributionCounts = {
        'व्यक्ति A': fixedFood.personA,
        'व्यक्ति B': fixedFood.personB,
        'व्यक्ति C': fixedFood.personC
    };
    ...
    this.addQuestionObject(this.add.text(
        140,
        30,
        'अब भोजन को उस तरीके से बाँटिए, जो आपके विचार में आज और भविष्य में जीवित रहने वाले लोगों की संख्या को अधिकतम करेगा।',
        {
            fontSize: '25px',
            color: '#000000',
            align: 'center',
    ...
    this.personDropZones = {
        'व्यक्ति A': this.add.zone(260, baselineY + 25, 210, 270).setRectangleDropZone(210, 270),
        'व्यक्ति B': this.add.zone(640, baselineY + 25, 210, 270).setRectangleDropZone(210, 270),
        'व्यक्ति C': this.add.zone(1020, baselineY + 25, 210, 270).setRectangleDropZone(210, 270)
    };
...
createPartialRedistributionFoodPieces ()
{
    ...
    const people = [
        { label: 'व्यक्ति A', amount: fixedFood.personA },
        { label: 'व्यक्ति B', amount: fixedFood.personB },
        { label: 'व्यक्ति C', amount: fixedFood.personC }
    ];
        ...
        if (!this.partialRedistributionNextShown)
        {
            ...
            this.createNextButton(640, 675, 'अगला', () => {
                this.gameData.partialRedistributionFinal.personA =
                    this.partialRedistributionCounts['व्यक्ति A'];

                this.gameData.partialRedistributionFinal.personB =
                    this.partialRedistributionCounts['व्यक्ति B'];

                this.gameData.partialRedistributionFinal.personC =
                    this.partialRedistributionCounts['व्यक्ति C'];
...
showPartialRedistributionPreferenceQuestion ()
{
    ...
    this.addQuestionObject(this.createStaticHumanAvatar(260, 125, 'व्यक्ति A', 0.78, 0xcc3333, fixedFood.personA));
    this.addQuestionObject(this.createStaticHumanAvatar(640, 125, 'व्यक्ति B', 0.72, 0x3366cc, fixedFood.personB));
    this.addQuestionObject(this.createStaticHumanAvatar(980, 125, 'व्यक्ति C', 0.66, 0x339966, fixedFood.personC));
    ...
    const answers = Phaser.Utils.Array.Shuffle([
        'जिस व्यक्ति के पास 5 से अधिक भोजन के टुकड़े हों, उसे अपना अतिरिक्त भोजन उस व्यक्ति के साथ साझा करना चाहिए जिसे जीवित रहने के लिए अधिक भोजन की आवश्यकता है।',
        'समूह के प्रत्येक सदस्य को वही भोजन अपने पास रखना चाहिए जो उसने स्वयं इकट्ठा किया है।'
    ]);
...
showRedistributionRulesQuestion ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        160,
        'निम्नलिखित में से कौन-से वितरण आज और भविष्य में जीवित रहने वाले लोगों की संख्या को अधिकतम करेंगे? लागू होने वाले सभी विकल्पों का चयन करें।',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
   ...
   const options = Phaser.Utils.Array.Shuffle([
    {
        label: 'प्रत्येक व्यक्ति अपने द्वारा एकत्र किया गया भोजन अपने पास रखता है।',
        key: 'noRedistribution'
    },
    {
        label: 'समूह सभी सदस्यों के बीच भोजन को समान रूप से बाँटता है।',
        key: 'equalRedistribution'
    },
    {
        label: 'जिस व्यक्ति के पास 5 से अधिक भोजन के टुकड़े हों, उसे अपना अतिरिक्त भोजन उस व्यक्ति के साथ साझा करना चाहिए जिसे जीवित रहने के लिए अधिक भोजन की आवश्यकता है।',
...
createNextButton (x, y, label, callback)
{
    ...
    const buttonWidth = label === 'खेल प्रारंभ करें' ? 220 : 160;

    const button = this.add.rectangle(x, buttonY, buttonWidth, 55, 0x000000);
    button.setInteractive({ useHandCursor: true });
    button.setDepth(1000);
