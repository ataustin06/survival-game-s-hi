...
showFloodPreparationQuestion ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        400,
        'क्या समूह को अपना समय दिन के लिए भोजन इकट्ठा करने में बिताना चाहिए या कुछ हफ्तों में आने वाली बाढ़ का सामना करने के लिए स्थान को तैयार करने में?',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
    ...
    const answers = Phaser.Utils.Array.Shuffle([
    'समूह को अपना समय दिन के लिए भोजन इकट्ठा करने में बिताना चाहिए।',
    'समूह को अपना समय दो हफ्तों में आने वाली बाढ़ का सामना करने के लिए स्थान को तैयार करने में बिताना चाहिए।'
    ]);
...
const personCDisplayFood = fixedFood.personC;
    ...
    this.addQuestionObject(this.add.text(
        640,
        330,
        'क्या आपको लगता है कि इस परिस्थिति में समूह की गतिशीलता अधिक सहयोगात्मक होगी या अधिक प्रतिस्पर्धात्मक?',
        {
            fontSize: '28px',
            color: '#000000',
            align: 'center',
    ...
    const answers = Phaser.Utils.Array.Shuffle([
'इस परिस्थिति में, इस समूह के लोग अधिक सहयोगात्मक हैं।',
'इस परिस्थिति में, इस समूह के लोग अधिक प्रतिस्पर्धात्मक हैं।'
    ]);
